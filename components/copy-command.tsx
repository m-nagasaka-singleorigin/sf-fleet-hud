...
export function CopyCommand({ name }: { name: string }) {
  ...
  return (
    <button
      ...
      className="cursor-pointer font-mono text-[9px] uppercase tracking-[0.16em] text-[#5A6065] transition-colors outline-none hover:text-primary focus-visible:text-primary"
    >
